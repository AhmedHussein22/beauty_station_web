...
class Responsive extends StatelessWidget {
  ...
  static bool isMobile(BuildContext context) => MediaQuery.of(context).size.width <= 400;

  static bool isMobileLarge(BuildContext context) => MediaQuery.of(context).size.width <= 465;
